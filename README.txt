...
- Undo feature:
  undo of editing, adding is fully implemented (may crash application if undo is called on removed object, due to not implemented undo of removing),
...
Generated files:
*.ui files were generated by Qt creator.
